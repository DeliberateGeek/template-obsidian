# Commit Message Guidelines — Obsidian Vault Template

This file defines project-specific commit types and scopes for Obsidian vault projects. All other commit rules (format, attribution, workflow) are defined in the global `commit-workflow-checklist.md`.
